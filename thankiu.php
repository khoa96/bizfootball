  ...
  <div class="container">
    <div class="thankiu-page-wrapper">
      ...
      <svg width="96" height="96" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="4" y="4" width="88" height="88" rx="44" fill="#FDC400" />
        <g clip-path="url(#clip0_291_6121)">
          <path d="M29.334 48L42.6673 61.3333L69.334 34.6667" stroke="#1A202C" stroke-width="6" stroke-linecap="round" stroke-linejoin="round" />
        </g>
        <defs>
          <clipPath id="clip0_291_6121">
